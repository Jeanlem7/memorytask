...
% Interroge la durée de l'image 
ifi = Screen ( 'GetFlipInterval' , w);

% Configurer le mélange alpha pour des lignes lisses (anti-aliasées) 
...
for phase=:2 % 1 is study phase, 2 is the test phase                
...
%----------------------------------------------------------------------
%                        Fixation Cross: Finished
%----------------------------------------------------------------------

% Set the line width for our fixation cross
lineWidthPix = 4;
% Set the length of the lines (in Pixels) of the fixation cross
fixCrossDimPix = 20;   
...
>>>>>>> 87cb0330a755df70be3e0de750bd78e6bcd81d80
